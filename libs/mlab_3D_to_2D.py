...
# https://docs.enthought.com/mayavi/mayavi/auto/example_mlab_3D_to_2D.html?highlight=3d%202d
...
def get_world_to_view_matrix(mlab_scene):
    ...
    if not isinstance(mlab_scene, MayaviScene) and not isinstance(mlab_scene, MlabSceneModel):
        raise TypeError('argument must be an instance of MayaviScene or MlabSceneModel')
...
if __name__ == '__main__':
    ...
    print("disp_coords shape:", disp_coords.shape, "\n", disp_coords)
